                ...
                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="box-checked-in d-flex align-items-center justify-content-between">
                                            <div class="d-flex gap-5">
                                                <div class="w-100 form-group form-date-field form-date-search clearfix  has-icon d-flex align-items-center  gap-1"
                                                    ...
                                                    <div class="date-wrapper clearfix">
                                                        <div class="check-in-wrapper d-flex align-items-center gap-1 ">
                                                            <label style="min-width: max-content;">Check In - Check Out</label>
                                                            <!-- <div class="inputg check-in-render">01/07/2019</div> -->
                                                            <input type="text" id="daterange1" class="form-control" style="border: 0;background-color: #f7f7f7;" name="daterange1" value="" />
                                                        </div>
                                                    </div>
                                                    <input type="hidden" class="check-in-input" value="" name="hiddendaterange1">
                                                ...
                                                <!-- <div class="form-group form-date-field form-date-search clearfix  has-icon d-flex align-items-center gap-1 " data-format="DD/MM/YYYY">
                                                    <i class="fas fa-calendar-check input-icon field-icon"></i>
                                                    <div class="date-wrapper clearfix">
                                                        <div class="check-in-wrapper d-flex align-items-center gap-1">
                    ...
                    <div class="col-xs-12 col-md-3 ">
                        <div class="summary-box">
                            ...
                            <ul>
                                <li style="font-weight: bold;"><i class="fas fa-bed"></i> 1 Room, 2 Adults, 0 Children.</li>
                                <li style="font-weight: bold;"><span><i class="far fa-calendar-check"></i> Check-in&nbsp;:</span> 05/07/2019</li>
                                <li style="font-weight: bold;"><span><i class="far fa-calendar-times"></i> Check-out&nbsp;:</span> 06/07/2019</li>
                                <li style="font-weight: bold;"><i class="far fa-moon"></i> 1 Night</li>
                            </ul>
                        </div>
