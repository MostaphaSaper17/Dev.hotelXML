            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="profile-userbuttons mar-b-20">
                        ...
                        <!-- Button -->
                        <a href="#!" class="btn_1 medium" id="topUpButton">Top up by credit card</a>

                        <div id="visaCardInput" style="display:none;">

                            <div class="container-form">
                                <div class="form-area">
                                    <label for="">Card Number</label>
                                    <input type="text" placeholder="Card Number" class="form-control inputg">
                                </div>
                                <div class="form-area">
                                    <label for="">Expiry Date</label>

                                    <input type="text" placeholder="Expiry Date" class="form-control inputg">
                                </div>
                                <div class="form-area">
                                    <label for=""> CVV</label>

                                    <input type="text" placeholder="CVV" class="form-control inputg">
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        // -- Bar Chart Credit Statement Total and Available Balance
        var ctx = document.getElementById("myBarChart-2");
        var myLineChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ["Total Debit", "Available Balance"],
            datasets: [{
            label: "Revenue",
...
// -- Pie Chart Example
        ...
        document.getElementById("topUpButton").addEventListener("click", function() {
            var visaInput = document.getElementById("visaCardInput");
            if (visaInput.style.display === "none") {
