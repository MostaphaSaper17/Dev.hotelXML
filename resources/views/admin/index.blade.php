...
<div class="col-12 col-sm-6 col-lg-4 col-xl-3 col-xxl-2 px-2 my-2">
	<div class="col-12 px-0 py-1 d-flex main-box-wedit" >
		...
		<div style="width: calc(100% - 80px)" class="px-2 py-2">
			<a class="font-1" href="{{route('admin.agents.index')}}" style="color: #212529;">
				B2B Users
...
<div class="col-12 col-sm-6 col-lg-4 col-xl-3 col-xxl-2 px-2 my-2">
	<div class="col-12 px-0 py-1 d-flex main-box-wedit" >
		...
		<div style="width: calc(100% - 80px)" class="px-2 py-2">
			<a class="font-1" href="{{route('admin.booking-reports.index')}}" style="color: #212529;">
				Booking Orders
				<h6 class="font-3">
                    {{\App\Models\ManualBooking::count()}}
                </h6>
			</a>
		</div>
	</div>
