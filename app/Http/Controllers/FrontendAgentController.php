...
class FrontendAgentController extends Controller
{
    ...
    public function profile()
    {
        ...
        $countries = Country::all();
        $closed_tickets = SupportTicket::where('agent_id',$agent->company_name)->where('status','Closed')->orderBy('id', 'desc')->get();
        $open_tickets = SupportTicket::where('agent_id',$agent->company_name)->where('status','Open')->orderBy('id', 'desc')->get();
    ...
    {
        return view('website.agent.legal-notice');
    }
    public function privacy_policy()
    {
        return view('website.agent.privacy-policy');
    }
